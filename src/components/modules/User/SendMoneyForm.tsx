...
const formSchema = z.object({
  toNumber: z.string().length(11, {
    message: "Receipient's Number should be 11 in digits",
  }),
  amount: z
    .string()
...
const SendMoneyForm = () => {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try{
      ...
      console.log("SEND MONEY FORM ERROR-->", error)      
  ...
  return (
    <>
      <Card className="w-full">
        <CardHeader className="flex items-center font-semibold"><Send className="w-5 h-5" /> Send Money Details</CardHeader>
